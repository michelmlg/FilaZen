...
const navItems = [
  { name: 'Fila', path: '/', icon: LayoutDashboardIcon },
        ...
        <div class="flex flex-col h-0 flex-1 border-r border-border bg-card">
          <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
            <div class="flex items-center justify-center flex-shrink-0 px-4 mb-4">
              <img :src="filazenLogo" alt="FilaZen" class="h-8 w-auto" />
            </div>
            ...
            <nav class="mt-5 flex-1 px-2 space-y-1">
              ...
              <!-- Apenas Manager/Admin vienen los Ajustes -->
          ...
          <div class="flex-shrink-0 flex border-t border-border p-4">
            <div class="flex items-center w-full">
              ...
              <button @click="logout" class="ml-auto flex-shrink-0 p-1 text-muted-foreground hover:text-destructive" title="Sair">
